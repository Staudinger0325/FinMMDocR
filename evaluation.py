...
def get_result(processed_data):
    ...
    if len(topic_execution_rates) > 0:
...
def evaluate_pot_pred_file(prediction_data, ground_truth_data, client, timeout_duration=3):
    ...
    for example in tqdm(prediction_data):
        ...
        # if "python_solution" in ground_truth_data[question_id]:
        ...
        # else:
        ground_truth_executed_result = ground_truth_data[question_id]['ground_truth']
